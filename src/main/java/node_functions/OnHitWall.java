...
public class OnHitWall extends CommandGene {

    private int max_length;
    private HashMap<SubTreeTypes, String> map;

    public OnHitWall(GPConfiguration config, int max_length) throws Exception {
    ...
    public Object execute_object(ProgramChromosome c, int n, Object[] args) {
        ...
        SubTreeTypes newType = SubTreeTypes.ON_HIT_WALL;
