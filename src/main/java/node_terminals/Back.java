...
public class Back extends CommandGene {
    ...
    public Back(GPConfiguration a_conf, Class a_returnType, double mean, double deviation, int a_subReturnType) throws InvalidConfigurationException {
